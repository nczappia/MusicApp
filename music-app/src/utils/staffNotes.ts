...
// 2 ledger lines below (E2, F2) and 2 above (B3, C4)
const BASS_NOTES: StaffNote[] = [
  { clef: "bass", step: -2, name: "E", octave: 2, label: "E2" },
  { clef: "bass", step: -1, name: "F", octave: 2, label: "F2" },
  { clef: "bass", step:  0, name: "G", octave: 2, label: "G2" },
  { clef: "bass", step:  1, name: "A", octave: 2, label: "A2" },
  { clef: "bass", step:  2, name: "B", octave: 2, label: "B2" },
  { clef: "bass", step:  3, name: "C", octave: 3, label: "C3" },
  { clef: "bass", step:  4, name: "D", octave: 3, label: "D3" },
  { clef: "bass", step:  5, name: "E", octave: 3, label: "E3" },
  { clef: "bass", step:  6, name: "F", octave: 3, label: "F3" },
  { clef: "bass", step:  7, name: "G", octave: 3, label: "G3" },
  { clef: "bass", step:  8, name: "A", octave: 3, label: "A3" },
  { clef: "bass", step:  9, name: "B", octave: 3, label: "B3" },
  { clef: "bass", step: 10, name: "C", octave: 4, label: "C4" },
];
